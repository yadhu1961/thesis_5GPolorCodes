...
\LNTtitle{Master's Thesis}          % Thesis type / Art der Arbeit (Master's Thesis, Diplomarbeit)
    {Low Latency Polar FEC Chain Development in Software for 5G}                  % Thesis title / Titel der Arbeit
...
\LNTrecht{Yadhunandana Rajathadripura Kumaraiah}             % Your name / Name des Studenten
    {M\"unchen, 21.11.2018}         % Munich, Date / Muenchen, Datum
...
% arabic page numbering, starting with page number 1 / arabische Seitennummerierung beginnend mit Seite 1
    ...
    \pagenumbering{arabic}
        ...
        \include{introduction}  % Include introduction / Einbinden des Kapitels Einleitung/Problemstellung
        \include{Background} 	% Background about polar codes and their usage in 5G.
        \include{polarCodes}  %Explain control channels, Block-length and modulation formats,
        \include{EncodingChain} % Contains the details of encoding FEC chain.
        \include{DecodingChain} % Include ... / Einbinden des Kapitels ...
