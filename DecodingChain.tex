...
Decoding latency can be further reduced by minimizing the number of nodes to be traversed in a decoder tree. This can be achieved decoding tree pruned intelligently at a particular level based on SNR and code rate.
