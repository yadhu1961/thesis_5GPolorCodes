...
\TODO{Add picture showing unrolled decoder here.}
...
%This pruning can also be viewed as a adoptive pruning to 
...
\TODO{Here compare the decoding latency of this implementation and state of the art latency values}

\TODO{Add the picture here showing pruning of decoding tree irrespective of node type}
