...
\begin{code}
	...
	\begin{minted}{c++}
template<>
inline int isRateOneCode<256>(uint64_t s[]) {
	__m256i temp1 = _mm256_loadu_si256 ((__m256i*)s);
	//Filling whole vector with zero's
	__m256i temp2 = _mm256_set1_epi8(0);
	uint8_t result = (uint8_t)_mm256_cmpeq_epi64 (temp1, temp2)[0];
	return result;
}
\end{minted}
\end{code}
