...
\begin{figure}[]
	\centering
	\includegraphics[width=0.7\textwidth]{./figures/simd_code.pdf}
	\caption{Node operation with SIMD}
	\label{fig:simd_code_snippet}
\end{figure}
...
\TODO{Nothing much for now, May be subblock interleaver can be optimized to reduce the latency by 10us in rate matching process}
